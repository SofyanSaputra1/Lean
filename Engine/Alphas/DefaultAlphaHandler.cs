...
namespace QuantConnect.Lean.Engine.Alphas
{
    ...
    public class DefaultAlphaHandler : IAlphaHandler
    {
        ...
        public virtual void Initialize(AlgorithmNodePacket job, IAlgorithm algorithm, IMessagingHandler messagingHandler, IApi api)
        {
            ...
            AlphaManager.AlphaClosed += (sender, context) => StatisticsUpdater.OnAlphaAnalysisCompleted(RuntimeStatistics, context);
            AlphaManager.AlphaAnalysisCompleted += (sender, context) => StatisticsUpdater.OnAlphaClosed(RuntimeStatistics, context);
